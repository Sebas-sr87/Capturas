...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Supervisor s = Query.loginUser(user, pass);
            if (s==null) {
                request.getSession().setAttribute(PARAM_USER_ERROR, "Usuario no v&aacute;lido");
                response.sendRedirect("index.jsp");
            } else {
                request.getSession().setAttribute(PARAM_USER, s);
